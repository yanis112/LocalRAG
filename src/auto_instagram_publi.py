...
ex2=""" 🔥🌑 Witness the epic scenes from *The Silmarillion* brought to life in stunning AI visuals! ⚔️ The mighty Balrogs blaze with fury, while the Elves stand in defiance 🏹✨. Cities crumble under the shadow of the Dark Lord, Morgoth himself, as the fall of kingdoms echoes through time 🏰💀. A legendary tale of light and darkness, where heroes rise and empires fall.
...
ex3="""One Piece imagined in Ghibli Studio style ! 🔥#onepiece #ghibli #ghiblistudio #ai #aiart #aiartcommunity #midjourney #abstractart #art #onepiecefan #onepieceanime"""

ex4="""👽👽 Alien creature reported in the countryside near Nashville, these creatures reportedly left no survivor. #ai #aiart #aiartcommunity #midjourney #midjourneyart #aliens #art #artist"""


def instagram_descr_prompt(base_prompt):
    ...
    exemples_prompt= f"""Here are some examples of good quality instagram descriptions to help you: Example 1: {ex1} \n\n Example 2: {ex2} \n\n Example 3: {ex3} \n\n Example 4: {ex4} \n\n """
